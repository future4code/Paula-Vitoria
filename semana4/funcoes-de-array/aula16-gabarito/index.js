...
function imprimirDespesas(despesas){
    ...
    const callback = (despesa) =>{
        divDespesas.innerHTML +=`<div>Valor da despesa :${despesa.valor} | Tipo:${despesa.tipo} | Descricao: ${despesa.descricao}</div>`
    }
    
    despesas.forEach(callback);
    
   // divDespesas.innerHTML +=`<div>${despesas}</div>`
...
function filtrarDespesas(){
    ...
    console.log("Filtros:" +despesasFiltradas);
